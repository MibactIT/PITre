<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReplicaInAoo.aspx.cs" Inherits="DocsPAWA.AdminTool.Gestione_ProfDinamica.ReplicaInAoo" %>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td align="center" width="10%" bgcolor="#e0e0e0">
                        <asp:Button ID="btn_conferma" runat="server" Text="Conferma" OnClick="btn_conferma_Click" CssClass="testo_btn_p"></asp:Button></td>
                </tr>
                <tr>
                    <td colspan="2">
