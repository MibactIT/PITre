    ...
    public partial class ReplicaInAoo : System.Web.UI.Page
    {
        ...
        protected void btn_conferma_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    DocsPAWA.DocsPaWR.Templates template = (DocsPAWA.DocsPaWR.Templates)Session["templateSelPerReplicaDoc"];
                    if (!ProfilazioneDocManager.ReplicaTipoDocumento(idAmministrazioniSelezionate, template.ID_TIPO_ATTO))
                        throw new Exception();
