...
{
    /// <summary>
    /// Object that contains s Marking Request.&lt;br/&gt;  The order of fields is important for WSDL
    /// </summary>
    [DataContract]
    public partial class JsonMarkRequest :  IEquatable<JsonMarkRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonMarkRequest" /> class.
        /// </summary>
        /// <param name="user">Username of Marking Credential.</param>
        /// <param name="password">Password of Marking Credential.</param>
        /// <param name="transport">Enum Class that indicates the type of input (trasport)  &lt;ul&gt;  &lt;li&gt;BYNARYNET&lt;/li&gt;  &lt;li&gt;FILENAME&lt;/li&gt;  &lt;li&gt;DIRECTORYNAME&lt;/li&gt;  &lt;li&gt;STREAM&lt;/li&gt;  &lt;/ul&gt;.</param>
        /// <param name="binaryinput">Byte Array that contains the document (only for Transport &#x3D; BINARYNET).</param>
        /// <param name="srcName">Path to file OR directory path that contains the files to be marked (only for Transport &#x3D; FILENAME or DIRECTORYNAME).</param>
        ...
        /// <param name="notifyId">ID to associate to signatures session for notifications.</param>
        /// <param name="stream">Stream used to download large size file (only for Transport &#x3D; STREAM).</param>
        public JsonMarkRequest(string user = default(string), string password = default(string), JsonTypeTransport transport = default(JsonTypeTransport), string binaryinput = default(string), string srcName = default(string), string dstName = default(string), string notifymail = default(string), string notifyId = default(string), string stream = default(string))
        {
            this.User = user;
        ...
        /// <summary>
        /// Username of Marking Credential
        /// </summary>
        /// <value>Username of Marking Credential</value>
        [DataMember(Name="user", EmitDefaultValue=false)]
        public string User { get; set; }

        /// <summary>
        /// Password of Marking Credential
        /// </summary>
        /// <value>Password of Marking Credential</value>
        [DataMember(Name="password", EmitDefaultValue=false)]
        public string Password { get; set; }

        /// <summary>
        /// Enum Class that indicates the type of input (trasport)  &lt;ul&gt;  &lt;li&gt;BYNARYNET&lt;/li&gt;  &lt;li&gt;FILENAME&lt;/li&gt;  &lt;li&gt;DIRECTORYNAME&lt;/li&gt;  &lt;li&gt;STREAM&lt;/li&gt;  &lt;/ul&gt;
        /// </summary>
        /// <value>Enum Class that indicates the type of input (trasport)  &lt;ul&gt;  &lt;li&gt;BYNARYNET&lt;/li&gt;  &lt;li&gt;FILENAME&lt;/li&gt;  &lt;li&gt;DIRECTORYNAME&lt;/li&gt;  &lt;li&gt;STREAM&lt;/li&gt;  &lt;/ul&gt;</value>
        ...
        /// <summary>
        /// Path to file OR directory path that contains the files to be marked (only for Transport &#x3D; FILENAME or DIRECTORYNAME)
        /// </summary>
        /// <value>Path to file OR directory path that contains the files to be marked (only for Transport &#x3D; FILENAME or DIRECTORYNAME)</value>
        ...
        /// <summary>
        /// ID to associate to signatures session for notifications
        /// </summary>
        /// <value>ID to associate to signatures session for notifications</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JsonMarkRequest {\n");
        ...
        {
            return this.Equals(input as JsonMarkRequest);
        }

        /// <summary>
        /// Returns true if JsonMarkRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonMarkRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonMarkRequest input)
        {
            if (input == null)
                return false;
