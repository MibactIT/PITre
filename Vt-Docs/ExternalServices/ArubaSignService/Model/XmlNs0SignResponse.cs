...
namespace ArubaSignServiceRest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XmlNs0SignResponse : XmlNs0EWSResult,  IEquatable<XmlNs0SignResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlNs0SignResponse" /> class.
        /// </summary>
        ...
        public XmlNs0SignResponse(string binaryOutput = default(string), string dstPath = default(string), string stream = default(string), string code = default(string), string message = default(string), string status = default(string)) : base()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XmlNs0SignResponse {\n");
        ...
        {
            return this.Equals(input as XmlNs0SignResponse);
        }

        /// <summary>
        /// Returns true if XmlNs0SignResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of XmlNs0SignResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XmlNs0SignResponse input)
        {
            if (input == null)
                return false;
