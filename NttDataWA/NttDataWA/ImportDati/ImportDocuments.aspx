                        ...
                        <asp:UpdatePanel ID="box_upload" runat="server">
                            <ContentTemplate>
                                <fieldset class="basic4">
                                    ...
                                    <div class="col"><a id="lnkDownload" runat="server" href="ZipDocumenti.aspx" visible="false"><img src="../Images/Icons/download_big.png" alt="" /></a></div>
                                </fieldset>
                                ...
                                <asp:PlaceHolder id="plcReport" runat="server" Visible="false">
                                    <div id="tabs">
                                        <ul>
                                            ...
                                            <asp:PlaceHolder ID="plcLiArrive" runat="server"><li><a href="#tabs-2"><asp:Literal ID="lblTabArrive" runat="server"></asp:Literal></a></li></asp:PlaceHolder>
                                            <li><a href="#tabs-3"><asp:Literal ID="lblTabLeaving" runat="server"></asp:Literal></a></li>
                                            <li><a href="#tabs-4"><asp:Literal ID="lblTabInternal" runat="server"></asp:Literal></a></li>
                                            <li><a href="#tabs-5"><asp:Literal ID="lblTabGray" runat="server"></asp:Literal></a></li>
                                            <asp:PlaceHolder ID="plcLiAttachments" runat="server"><li><a href="#tabs-6"><asp:Literal ID="lblTabAttachments" runat="server"></asp:Literal></a></li></asp:PlaceHolder>
